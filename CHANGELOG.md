...
Updates default compression and fixes missing dependencies.

### `Added`
- python-build-package.yml action
- banners and updated README.md

### `Fixed`
- CLI help
- default compression is now 'zlib'
- updated 'pyproject.toml' - imagecodecs and psutil as dependencies
- updated 'environment.yml' - nodefaults
- updated minimum Python version to 3.11
- updated workflow actions to use more up-to-date versions

### `Removed`
- Python 3.9 and 3.10 as valid versions
